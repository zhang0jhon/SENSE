...
def ms_deform_attn_core_pytorch(value, value_spatial_shapes, sampling_locations, attention_weights, align_corners):
    """
    ...
    for lid_, (H_, W_) in enumerate(value_spatial_shapes):
        ...
        # N_*M_, D_, Lq_, P_
        sampling_value_l_ = F.grid_sample(value_l_, sampling_grid_l_, mode='bilinear', padding_mode='zeros', align_corners=align_corners) # eg. [bs * 8, 32, 1045, 4]
...
class MSDeformAttn(nn.Module):
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes, input_level_start_index, input_padding_mask=None, align_corners=False):
        """
        ...
        output = ms_deform_attn_core_pytorch(value, input_spatial_shapes, sampling_locations, attention_weights, align_corners)
